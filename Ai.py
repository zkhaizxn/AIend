...
def init_db():
    ...
    if cursor.fetchone()[0] == 0:
        sample_dishes = [
            # ---------- 1F 菜品（无任何海鲜类，只有淡水鱼和普通肉类/素菜） ----------
            ("清炒西兰花", 120, 5, 3, "清淡", "减脂", "无", 8, "素菜", "1F"),
            ("香辣鸡丁", 350, 25, 18, "辣", "增肌", "花生", 15, "肉类", "1F"),
            ("红烧鱼块", 280, 22, 12, "咸鲜", "常规", "鱼类", 18, "鱼类", "1F"),
            ("蒜蓉空心菜", 90, 4, 2, "清淡", "减脂", "无", 6, "素菜", "1F"),
            ("黑椒牛肉", 420, 30, 22, "辣", "增肌", "牛肉", 22, "肉类", "1F"),
            ("麻婆豆腐", 200, 12, 14, "辣", "常规", "大豆", 10, "素菜", "1F"),
            ("糖醋里脊", 380, 18, 20, "酸甜", "常规", "猪肉", 20, "肉类", "1F"),
            ("番茄炒蛋", 160, 8, 9, "酸甜", "减脂", "鸡蛋", 10, "素菜", "1F"),
            ("土豆炖牛腩", 450, 28, 25, "咸鲜", "增肌", "牛肉", 28, "肉类", "1F"),
            ("干煸四季豆", 210, 5, 14, "辣", "常规", "无", 12, "素菜", "1F"),
            ("宫保鸡丁", 320, 24, 16, "辣", "常规", "花生", 18, "肉类", "1F"),
            ("酸辣土豆丝", 150, 3, 7, "酸辣", "减脂", "无", 8, "素菜", "1F"),
            ("鱼香肉丝", 280, 16, 14, "酸甜", "常规", "猪肉", 16, "肉类", "1F"),
            ("手撕包菜", 130, 3, 8, "辣", "减脂", "无", 10, "素菜", "1F"),
            ("小炒黄牛肉", 390, 32, 20, "辣", "增肌", "牛肉", 26, "肉类", "1F"),

            # ---------- 2F 菜品（包含多种海鲜：虾、贝、海鱼） ----------
            ("蒜蓉粉丝蒸扇贝", 180, 15, 8, "清淡", "增肌", "贝类", 28, "鱼类", "2F"),
            ("香辣虾", 320, 22, 18, "辣", "增肌", "虾", 32, "鱼类", "2F"),
            ("清蒸海鲈鱼", 220, 26, 9, "清淡", "常规", "鱼类", 35, "鱼类", "2F"),
            ("白灼菜心", 80, 3, 2, "清淡", "减脂", "无", 8, "素菜", "2F"),
            ("孜然羊肉", 410, 30, 24, "辣", "增肌", "羊肉", 26, "肉类", "2F"),
            ("上汤娃娃菜", 110, 4, 6, "清淡", "减脂", "无", 12, "素菜", "2F"),
            ("剁椒鱼头", 290, 24, 14, "辣", "常规", "鱼类", 38, "鱼类", "2F"),
            ("姜葱炒花蛤", 170, 16, 7, "咸鲜", "常规", "贝类", 24, "鱼类", "2F"),
            ("红烧排骨", 390, 24, 28, "咸鲜", "增肌", "猪肉", 25, "肉类", "2F"),
            ("荷塘小炒", 130, 6, 5, "清淡", "减脂", "无", 11, "素菜", "2F"),
            ("避风塘炒蟹", 340, 22, 24, "咸鲜", "常规", "蟹", 48, "鱼类", "2F"),
            ("酱爆鱿鱼须", 260, 20, 12, "辣", "常规", "鱿鱼", 30, "鱼类", "2F"),
            ("葱油海瓜子", 140, 12, 6, "清淡", "减脂", "贝类", 22, "鱼类", "2F"),
            ("芝士焗龙虾", 480, 35, 28, "咸鲜", "增肌", "龙虾", 88, "鱼类", "2F"),
            ("蒜蓉生蚝", 150, 12, 9, "咸鲜", "常规", "贝类", 20, "鱼类", "2F"),

            # ---------- 3F 菜品（丰富海鲜及常规菜品） ----------
            ("香煎带鱼", 310, 24, 18, "咸鲜", "常规", "鱼类", 22, "鱼类", "3F"),
            ("葱姜炒蟹", 260, 20, 16, "咸鲜", "常规", "蟹", 42, "鱼类", "3F"),
            ("鲍鱼炖鸡", 350, 32, 18, "清淡", "增肌", "鲍鱼", 58, "鱼类", "3F"),
            ("白灼虾", 150, 20, 5, "清淡", "减脂", "虾", 30, "鱼类", "3F"),
            ("辣炒蛏子", 190, 18, 10, "辣", "常规", "贝类", 26, "鱼类", "3F"),
            ("蒜香生蚝", 140, 12, 8, "咸鲜", "增肌", "贝类", 20, "鱼类", "3F"),
            ("清炒上海青", 70, 3, 2, "清淡", "减脂", "无", 6, "素菜", "3F"),
            ("水煮牛肉", 520, 35, 32, "辣", "增肌", "牛肉", 38, "肉类", "3F"),
            ("东坡肉", 550, 20, 45, "咸鲜", "常规", "猪肉", 28, "肉类", "3F"),
            ("地三鲜", 210, 5, 12, "咸鲜", "减脂", "无", 14, "素菜", "3F"),
            ("椒盐皮皮虾", 290, 23, 17, "咸鲜", "常规", "虾", 45, "鱼类", "3F"),
            ("清蒸大闸蟹", 220, 18, 14, "清淡", "常规", "蟹", 35, "鱼类", "3F"),
            ("海胆蒸蛋", 120, 10, 7, "清淡", "增肌", "海胆", 28, "鱼类", "3F"),
            ("捞汁海鲜桶", 310, 28, 16, "酸辣", "减脂", "多种海鲜", 56, "鱼类", "3F"),
            ("XO酱爆带子", 250, 20, 13, "咸鲜", "增肌", "贝类", 42, "鱼类", "3F"),
        ]
        cursor.executemany('''
...
# ===== 新增：检查当前楼层是否有鱼类菜品（基于 category 字段）=====
def has_fish_on_floor(floor):
    """返回当前楼层是否存在 category='鱼类' 的菜品"""
    if not floor or floor == "全部":
        return True   # 全部楼层时不做限制，返回 True 让推荐正常进行
    conn = sqlite3.connect(DB_PATH)
    try:
        cursor = conn.cursor()
        cursor.execute("SELECT COUNT(*) FROM dishes WHERE floor = ? AND category = '鱼类'", (floor,))
...
6.如果用户只是想知道当前楼层有什么菜品，就告诉他当前楼层大概的菜品信息（例如素菜有哪些，肉菜有哪些这样的）。
7.食堂的营业时间一楼（星期一到星期五，早上7：30到下午9：00），二楼（周末，早上7：30到下午9：00），
三楼（星期一到星期五，早上7：30到下午9：00）。
"""
        ...
        with placeholder.container():
            with st.spinner("🤔 AI正在分析..."):
                try:
                    ...
                    fish_intent = any(
                        kw in prompt for kw in ["海鲜", "鱼", "虾", "蟹", "贝", "生蚝", "扇贝", "鲍鱼", "带鱼"])
                    current_floor = st.session_state.current_floor
                    if current_floor != "全部" and fish_intent:
                        if not has_fish_on_floor(current_floor):
                            no_fish_msg = f"😢 抱歉，{current_floor} 食堂没有鱼类菜品，请更换楼层（例如切换到2F或3F）。"
                            placeholder.markdown(no_fish_msg)
                            st.session_state.messages.append({"role": "user", "content": prompt})
                            st.session_state.messages.append({"role": "assistant", "content": no_fish_msg})
                            st.rerun()
                            time.sleep(1)
                            raise StopIteration
